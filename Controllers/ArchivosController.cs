...
public async Task<IActionResult> Eliminar(int id)
{
    ...
    if (!ModelState.IsValid)
    {
        // En caso de error de modelo, se podría redirigir a la vista de edición o a la acción GET de eliminar
        // Sin embargo, en el caso de la eliminación, generalmente se asume que solo se necesita el ID.
    }
